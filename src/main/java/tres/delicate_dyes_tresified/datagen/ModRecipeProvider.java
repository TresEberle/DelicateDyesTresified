...
//----------------------------------------------------------------------------------------------------------------------
        ...
        carpet(recipeOutput, ModBlocks.SACRAMENTO_CARPET, ModBlocks.SACRAMENTO_WOOL);
        ...
        stainedGlassPaneFromStainedGlass(recipeOutput, ModBlocks.SACRAMENTO_STAINED_GLASS_PANE, ModBlocks.SACRAMENTO_STAINED_GLASS);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SACRAMENTO_STAINED_GLASS_PANE.get(), 8)
                .pattern("###")
                .pattern("#X#")
                .pattern("###")
                ...
                .define('X', ModItems.SACRAMENTO_DYE)
                .unlockedBy("has_sacramento_dye", has(ModItems.SACRAMENTO_DYE))
                .save(recipeOutput, "delicate_dyes_tresified:sacramento_stained_glass_pane_from_dye");
//----------------------------------------------------------------------------------------------------------------------
